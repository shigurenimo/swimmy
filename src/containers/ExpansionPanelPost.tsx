...
class ExpansionPanelPost extends React.Component<Props, State> {
  isUnmounted = false
  ...
  onChangeExpand = (_: any, expanded: boolean) => {
  ...
  onClickPanelSummary = (event: ChangeEvent<any>) => {
...
export default withStyles(styles)(ExpansionPanelPost)
