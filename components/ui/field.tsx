...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-2.5 font-medium data-[variant=label]:text-base data-[variant=legend]:text-base",
        className
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-base/relaxed leading-normal font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
